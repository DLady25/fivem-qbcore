...
RegisterNetEvent('inventory:client:CheckOpenState', function(type, id, label)
    TriggerEvent('pappu-inventorynp:client:CheckOpenState', type, id, label)
end)

RegisterNetEvent('inventory:client:ItemBox', function(itemData, boxType, amount)
    TriggerEvent('pappu-inventorynp:client:ItemBox', itemData, boxType, amount)
end)

RegisterNetEvent('inventory:client:requiredItems', function(items, toggle)
    TriggerEvent('pappu-inventorynp:client:requiredItems', items, toggle)
end)

RegisterNetEvent('inventory:client:UpdateOtherInventory', function(items, isError)
    TriggerEvent('pappu-inventorynp:client:UpdateOtherInventory', items, isError)
end)

RegisterNetEvent('inventory:client:UpdatePlayerInventory', function(isError)
    TriggerEvent('pappu-inventorynp:client:UpdatePlayerInventory', isError)
end)

RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
    TriggerEvent('pappu-inventorynp:client:OpenInventory', PlayerAmmo, inventory, other)
end)

RegisterNetEvent('inventory:client:CloseInventory', function()
    TriggerEvent('pappu-inventorynp:client:closeinv')
end)
